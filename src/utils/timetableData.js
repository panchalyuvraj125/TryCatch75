...
export const FULL_TIMETABLE_METADATA = {
  Mon: {
    0: { subject: 'AI', location: 'CR 202', teacher: 'Prof. Sureshsingh Rajpurohit' },
    1: { subject: 'EB', location: 'CR 202', teacher: 'Govind Wakure' },
    2: { subject: 'EB', location: 'CR 202', teacher: 'Govind Wakure' },
    3: { subject: 'DM', location: 'CR 202', teacher: 'Prof. Tooba Shaikh' },
    4: { subject: 'UHV-II', location: 'CR 2', teacher: 'Prof. Neeraj Suchak' },
  },
  Tue: {
    2: { subject: 'PE', location: 'CR1', teacher: 'Prof. Aneri Sheth' },
    3: { subject: 'DM', location: 'CR1', teacher: 'Prof. Tooba Shaikh' },
    5: { subject: 'DS', location: 'CC1', teacher: 'Prof. Avina Devadiga' },
    6: { subject: 'DS', location: 'CC1', teacher: 'Prof. Avina Devadiga' },
    7: { subject: 'DSPPL', location: 'CC1', teacher: 'Prof. Adarsh Chaube', note: 'Theory' },
    8: { subject: 'DSPPL LAB', location: 'LAB-II, 5th Floor SBMP', teacher: 'Prof. Adarsh Chaube', batch: 'AM2' },
    9: { subject: 'DSPPL LAB', location: 'LAB-II, 5th Floor SBMP', teacher: 'Prof. Adarsh Chaube', batch: 'AM2' },
  },
  Wed: {
    ...
    4: { subject: 'EM3', location: 'CR2', teacher: 'Prof. Mayur Gohil' },
    5: { subject: 'UHV-II', location: 'CR2', teacher: 'Prof. Neeraj Suchak' },
    7: { subject: 'EB', location: 'CR-24B SBMP', teacher: 'Govind Wakure' },
  },
  Thu: {
    0: { subject: 'MINOR-OOP', location: 'CR201', teacher: 'Prof. Jharna Nagpal' },
    1: { subject: 'MINOR-OOP', location: 'CR201', teacher: 'Prof. Jharna Nagpal' },
    2: { subject: 'EM3', location: 'CR201', teacher: 'Prof. Mayur Gohil' },
    ...
    5: { subject: 'EM3', location: 'CR2', teacher: 'Prof. Mayur Gohil' },
    7: { subject: 'DS', location: 'CR2', teacher: 'Prof. Avina Devadiga' },
    8: { subject: 'PE', location: 'CR2', teacher: 'Prof. Aneri Sheth' },
  },
  Fri: {
    0: { subject: 'AI', location: 'CR2', teacher: 'Prof. Sureshsingh Rajpurohit' },
    1: { subject: 'LCSM', location: 'CR2', teacher: 'Prof. Prasad Dhuri' },
    2: { subject: 'UHV-II', location: 'CR 2', teacher: 'Prof. Neeraj Suchak' },
    3: { subject: 'DM', location: 'CR 2', teacher: 'Prof. Tooba Shaikh' },
    4: { subject: 'DSPPL LAB', location: '3rd Floor HW Lab', teacher: 'Prof. Adarsh Chaube', batch: 'AM2' },
    5: { subject: 'DSPPL LAB', location: '3rd Floor HW Lab', teacher: 'Prof. Adarsh Chaube', batch: 'AM2' },
  },
  Sat: {},
};
